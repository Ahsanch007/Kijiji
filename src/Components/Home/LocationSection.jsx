...
const locations = [
  { id: 9003, name: 'Alberta', isSelected: false, img: './assets/images/right-arrow (3).png' },
  { id: 9007, name: 'British Columbia', isSelected: false, img: './assets/images/right-arrow (3).png' },
  { id: 9006, name: 'Manitoba', isSelected: false, img: './assets/images/right-arrow (3).png' },
  { id: 9005, name: 'Brunswick', isSelected: false, img: './assets/images/right-arrow (3).png' },
  { id: 9008, name: 'New foundland', isSelected: false, img: './assets/images/right-arrow (3).png' },
  { id: 9002, name: 'Nova Scotia', isSelected: false, img: './assets/images/right-arrow (3).png' },
  { id: 9004, name: 'Ontario (A - L)', isSelected: false, img: './assets/images/right-arrow (3).png' },
  { id: 100009004, name: 'Ontario (M - Z)', isSelected: false, img: './assets/images/right-arrow (3).png' },
  { id: 9011, name: 'Prince Edward Island', isSelected: false, img: './assets/images/right-arrow (3).png' },
  { id: 9001, name: 'Québec', isSelected: false, img: './assets/images/right-arrow (3).png' },
  { id: 9009, name: 'Saskatchewan', isSelected: false, img: './assets/images/right-arrow (3).png' },
  { id: 9010, name: 'Territories', isSelected: false, img: './assets/images/right-arrow (3).png' },
];

const Alberta = [
  { id: "1700234", name: "Banff / Canmore", },
  { id: "1700199", name: "Calgary", },
  { id: "1700202", name: "Edmonton Area", img: './assets/images/right-arrow (3).png' },
...
const britishColumbia = [
  { id: "1700296", name: "Cariboo Area", href: "/h-cariboo-area/1700296", img: './assets/images/right-arrow (3).png' },
  { id: "1700298", name: "Comox Valley Area", href: "/h-comox-valley-area/1700298", img: './assets/images/right-arrow (3).png' },
  { id: "1700300", name: "Cowichan Valley / Duncan", href: "/h-cowichan-valley-duncan/1700300" },
  { id: "1700224", name: "Cranbrook", href: "/h-cranbrook/1700224" },
  { id: "1700139", name: "Fraser Valley", href: "/h-fraser-valley/1700139", img: './assets/images/right-arrow (3).png' },
  { id: "80003", name: "Greater Vancouver Area", href: "/h-greater-vancouver-area/80003", img: './assets/images/right-arrow (3).png' },
  { id: "1700227", name: "Kamloops", href: "/h-kamloops/1700227" },
  { id: "1700228", name: "Kelowna", href: "/h-kelowna/1700228", img: './assets/images/right-arrow (3).png' },
  { id: "1700263", name: "Nanaimo", href: "/h-nanaimo/1700263" },
  { id: "1700226", name: "Nelson", href: "/h-nelson/1700226" },
  { id: "1700295", name: "Peace River Area", href: "/h-peace-river-area/1700295", img: './assets/images/right-arrow (3).png' },
  { id: "1700299", name: "Port Alberni / Oceanside", href: "/h-port-alberni-oceanside/1700299", img: './assets/images/right-arrow (3).png' },
  { id: "1700301", name: "Port Hardy / Port McNeill", href: "/h-port-hardy-port-mcneill/1700301" },
  { id: "1700294", name: "Powell River District", href: "/h-powell-river-district/1700294" },
  { id: "1700143", name: "Prince George", href: "/h-prince-george/1700143" },
  { id: "1700302", name: "Revelstoke", href: "/h-revelstoke/1700302" },
  { id: "1700297", name: "Skeena-Bulkley Area", href: "/h-skeena-bulkley-area/1700297", img: './assets/images/right-arrow (3).png' },
...
const Manitoba = [
  { id: "1700085", name: "Brandon Area", link: "/h-brandon-area/1700085", img: './assets/images/right-arrow (3).png' },
...
const Newfoundland = [
  ...
  { locId: "1700044", name: "Labrador", img: './assets/images/right-arrow (3).png' },
...
const prince = [
  {
    id: 1, name: 'Prince Edward Island'
  }
]
const quebic = [
...
const locationData = [
  { id: 1700103, name: 'Northwest Territories', link: '/h-northwest-territories/1700103' },
    ...
    <div className='py-[30px]'>
      <div className="container mx-auto px-[15px]">
        <div className="select-container max-w-full md:max-w-[640px] mx-auto">
          <p className='py-[15px]'><strong>Welcome to Kijiji, Canada's most popular free, local classifieds site.</strong></p>
          <div className="select-location-box w-full bg-[#fff]">
            <div className="headerr bg-[#373373] text-white " style={{ padding: '15px 17px 13px', borderTopRightRadius: '3px', borderTopLeftRadius: '3px' }}>
              <h1 class="widget-title text-[14px] font-bold">Select Location</h1>
            </div>
            <div className="content w-full border border-[#d2d3d7] py-[15px] mb-[30px] px-3">
              <h2 class="title-instructions text-[#3e4153] text-[13px] font-bold pl-[17px] pb-[4px] border-b border-[#d2d3d7]">To see classifieds ads or post your own ad, click an area.</h2>
              <div className="py-3">
                  ...
                  <div className="main-list min-w-full md:min-w-[150px] mr-[20px] pl-[5px] border-b border-[#d2d3d7] md:border-none">
                    <ul className='list-none'>
                      {locations.map((link, index) =>
                        <li key={index} className={`py-[2px] px-[6px] text-[#3e4153] hover:text-[#3e4153] text-[13] hover:bg-[#f1f1f2] cursor-pointer flex justify-between items-center ${activeTab === index ? 'active-list' : ''}`} onClick={() => handleTabClick(index)}>
                          {link.name}
                  ...
                  <div className="tab-content  mr-[20px] pl-[5px]">
                    <ul className='list-none min-w-full md:min-w-[210px]'>
                      {getContent().map((item, index) =>
                        <li key={index} className='py-[2px] px-[6px] text-[#3e4153] hover:text-[#3e4153]  text-[13] hover:bg-[#f1f1f2] cursor-pointer flex justify-between items-center'>
                          {item.name}
